...
local localModVersion = "1.0.0" --temp fix, waiting for API to get version from mod.json

-- Project URL
local projectURL = "https://github.com/GramThanos/bf3-vu-day-night/"

-- Add check URL
local checkURL = "https://api.github.com/repos/GramThanos/bf3-vu-day-night/releases/latest"
-- Check URL examples:
